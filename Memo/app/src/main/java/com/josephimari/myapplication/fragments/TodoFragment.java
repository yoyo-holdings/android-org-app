...
import com.josephimari.myapplication.adapters.TodoAdapter;
...
public class TodoFragment extends Fragment
  ...
  @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    ButterKnife.bind(TodoFragment.this, rootView);
    return rootView;
  }
  ...
  @Override public Loader<List<MemoItem>> onCreateLoader(int id, Bundle args) {
    return new AsyncTaskLoader<List<MemoItem>>(getActivity()) {
      ...
      @Override public List<MemoItem> loadInBackground() {
        return DBHelper.getTodosFromDb();
      }
    };
  }
  ...
  private void initList() {
    ...
    adapter = new TodoAdapter(getActivity(), new ArrayList<MemoItem>(0));
    ...
    adapter.setOnCheckboxClickListener(new RecyclerUtil.TagClickListener() {
      @Override public void onItemClick(String payload, View v) {
        CompoundButton compoundButton = (CompoundButton) v;
        MemoItem m = DBHelper.getMemoItemById(Integer.parseInt(payload));
        m.taskCompleted = compoundButton.isChecked();
        m.save();
      }
    });
    adapter.setOnOverflowTagClickedListener(new RecyclerUtil.TagClickListener() {
      @Override public void onItemClick(String payload, View view) {
        ...
        popup.getMenuInflater().inflate(R.menu.menu_move_to_note, popup.getMenu());
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
          public boolean onMenuItemClick(MenuItem item) {
            switch (item.getItemId()) {
              case R.id.action_move_to_note:
                long timeNow = Calendar.getInstance().getTimeInMillis();
                m.type = MemoItem.TYPE_NOTE;
